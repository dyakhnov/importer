...
namespace importer
{
    public class Importer
    {
        ...
        public void Run()
        {
            ...
            EnvValidatior _envValidatior = new EnvValidatior();
            if (_envValidatior.IsValidTargetDirectory("source", sourceDirectory) &&
                _envValidatior.IsValidTargetDirectory("destination", destinationDirectory))
            {
